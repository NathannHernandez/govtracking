                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">LGU</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Barangay</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">HH ID</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Grantee Name</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Update Type</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Subject of Change</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Status</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Issue</th>
                                <th className="px-3 py-3 text-left text-xs font-medium text-black uppercase tracking-wider">Date</th>
                            </tr>
                        </thead>
                            ...
                            {isLoading ? (
                                ...
                                paginatedData.map((item, index) => (
                                    <tr key={item.id} className={`hover:bg-gray-50 transition-colors duration-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-25'}`}>
                                        <td className="px-3 py-4 text-sm text-black">{item.lgu}</td>
                                        <td className="px-3 py-4 text-sm text-black">{item.barangay}</td>
                                        ...
                                        <td className="px-3 py-4 text-sm text-black">{item.granteeName}</td>
                                        <td className="px-2 py-4 text-sm text-black">{item.typeOfUpdate}</td>
                                        <td className="px-3 py-4 text-sm text-black">{item.subjectOfChange}</td>
                                        ...
                                        <td className="px-1 py-4 text-sm text-black">
                                            {item.issue ? (
                                ...
                                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                    ...
                                    {[...Array(totalPages)].map((_, i) => {
                                        ...
                                        if (
                                            ...
                                            return (
                                                <span key={pageNum} className="relative inline-flex items-center px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-black">
                                                    ...
                                                </span>
                                            );
                                        }
