...
import { Database, Grid3X3, List } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">All Encoded Data</h1>
            <p className="text-gray-600">Manage and monitor your data across different modules</p>
          </div>
